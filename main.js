...
var timer_check, answer_holder, drawn_sketch = "";
var score , timer = 0;

function getObject(){
    randomNum = Math.floor((Math.random()*quick_draw_data_set.length)+1);
    console.log(quick_draw_data_set[randomNum]);
    sketchName = quick_draw_data_set[randomNum];
    document.getElementById("dl").innerText = " " + sketchName;
}
...
function gotResults(results, error){
    if(error){
        ...
        document.getElementById("il").innerText = results;
    }
}
